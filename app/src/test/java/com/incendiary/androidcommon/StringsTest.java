...
public class StringsTest extends TestCase {
    ...
    public void testSplitLines() {
        String[] lines = Strings.splitLines(LINES, false);
    ...
    public void testSplitLinesSkipEmptyLines() {
        String[] lines = Strings.splitLines(LINES, true);
    ...
    public void testFindLinesContaining() {
        ...
        List<String> lines = Strings.findLinesContaining(text, "XXX");
    ...
    public void testConcatLines() {
        ...
        String concated = Strings.concatLines(list);
        assertEquals("Line 1\nLine 2\n\nLine 4\nLine 5\n\nLine 7", concated);
    }
